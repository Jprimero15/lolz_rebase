...
if [ "$(grep -c Lol /proc/version)" -eq "1" ]; then
    ...
    echo "100" > /sys/devices/system/cpu/cpufreq/lolznappy/go_hispeed_load
    echo "0" > /sys/devices/system/cpu/cpufreq/lolznappy/io_is_busy
    echo "85 652800:45 729600:50 960000:55 1190400:60 1497600:70 1728000:75 1958400:85 2265600:95" > /sys/devices/system/cpu/cpufreq/lolznappy/target_loads
